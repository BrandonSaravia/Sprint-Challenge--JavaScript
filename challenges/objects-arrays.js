...
zooAnimals.forEach(function(currentValue){
  animalNames.push(currentValue.animal_name +' '+ currentValue.scientific_name);
})
...
const namesLowerCase = zooAnimals.map( function(currentValue){ 
    lowerCase.push(currentValue.animal_name.toLowerCase());
  });
...
*/
const populationTotal = zooAnimals.reduce(function(accumilator,currentValue){
  return accumilator + currentValue.population;}, 0);
